...
<body>
 <form:form id="depositForm" modelAttribute="deposittransaction" action="transactionProcess" method="post">
                ...
                <table align="center">
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <form:button id="deposit" name="deposit">Do deposit</form:button>
                        </td>
                    </tr>
                    <tr></tr>
                   <tr>
